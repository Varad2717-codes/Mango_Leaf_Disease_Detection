...
bg_image = get_base64_encoded_image(
    r"C:\Users\Varad\OneDrive\Desktop\Projec\plant_disease_project-main\mango.jpg"
)

remedy_bg = get_base64_encoded_image(
    r"C:\Users\Varad\OneDrive\Desktop\Projec\plant_disease_project-main\image.png"
)
...
@st.cache_resource
def load_model():
    model_path = r"C:\Users\Varad\OneDrive\Desktop\Projec\plant_disease_project-main\training\model.keras"
...
if uploaded_file is not None:
    ...
    if predicted_class == "Healthy":
        ...
        if remedy:
            ...
            remedy_text = generate_remedy_text(steps, remedy.get("time", "Unknown"))
            st.markdown(
                f"""
                <div class="remedy-box">
                    <h3 style="text-align:center;">📖 Remedy for {predicted_class}</h3>
                    <h4>💊 Treatment Steps:</h4>
                    <ul>{remedy_text.replace("\n", "<br>")}</ul>
                </div>
                """,
                unsafe_allow_html=True
            )
            ...
            st.markdown(
                ...
                <div class="download-container">
                    {create_download_link(remedy_text, f"{predicted_class}_remedy.txt")}
                </div>
                """,
                unsafe_allow_html=True
            )
